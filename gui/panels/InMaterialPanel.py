...
class InMaterialPanel(ControlPanel):
    ...
    def i_paint_main_head(self):
        ...
        self._create_label(self.HEADER_LABEL_X, self.header_widget_current_y, _.material_name_label)
        ...
        self._create_label(self.HEADER_LABEL_X, self.header_widget_current_y, _.material_in_count_label, width=60)
        self._create_widget(self.HEADER_WIDGET_X, self.header_widget_current_y, self.material_count_widget)

        self.header_widget_current_y += self.HEADER_WIDGET_STEP_Y

        self._create_label(self.HEADER_LABEL_X, self.header_widget_current_y, _.material_in_user_laebl, width=60)
        ...
        # 搜索类型标签
        self._create_label(self.HEADER_LABEL_X, self.header_widget_current_y, _.search_type, width=60)
    ...
    def __material_in_handle(self):
        ...
        INMATERIAL_UTIL.updateInMaterial(user.id, material.id, self.material_count)
